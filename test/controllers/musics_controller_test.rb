...
class MusicsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create music" do
    assert_difference("Music.count") do
      post musics_url, params: { music: { catalogue: @music.catalogue, content: @music.content, poster_id: @music.poster_id, poster_type: @music.poster_type, title: @music.title } }
    end
  ...
  test "should update music" do
    patch music_url(@music), params: { music: { catalogue: @music.catalogue, content: @music.content, poster_id: @music.poster_id, poster_type: @music.poster_type, title: @music.title } }

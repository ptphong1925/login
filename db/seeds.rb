...
rails generate scaffold User username password_digest first_name last_name phone token_user email balance:decimal nation birtday:datetime follows_count:integer role last_activity_at:datetime uid:integer provider
...
rails generate scaffold Notification name content user:references
rails generate scaffold AdminNotification name content admin:references
